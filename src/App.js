    ...
    <div id="body">
      ...
      <div id="mainsection" class="banner">
        <div class="links">
          ...
          <div class="firstword">
          <a class="old"><h1>Hello</h1></a>
         
           </div>
         

          <a class="old"><h1>I am</h1></a>
           

          <a class="old"><h1>Iuliia</h1></a>
      ...
      <div id="firstsection">
        <div class="about">
          <p>
            ...
            about two years of professional experience. I worked as a graphic
            designer for a small fashion brand O My Bag in Amsterdam: I've
            created designs for marketing campaigns, B2B pages and worked on the
            website design.
          </p>
          <p>
            I'm actively studying different aspects and techniques of graphic
            design, passed several design courses: fashion illustration,
            character design, motion design, Adobe Creative Suite (Photoshop,
            Illustrator, Premiere Pro, AfterEffects), and Procreate.
          </p>
        </div>
...
<p class="projectname">Project One</p>
</div>

<div id="projecttwo" class="project">
  <p class="projectname">Project Two</p>
</div>
